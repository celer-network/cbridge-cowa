...
pub const SUPPLIES: Map<Addr, u128> = Map::new("total_supply");
/// Every cw20 contract we allow to be burn is stored here
pub const ALLOW_LIST: Map<&Addr, bool> = Map::new("allow_list");
